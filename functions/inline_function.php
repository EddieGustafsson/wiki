...
include_once '../includes/Text/Diff.php';
include_once '../includes/Text/Diff/Renderer.php';
include_once '../includes/Text/Diff/Renderer/unified.php';

// this is my own renderer
include_once '../functions/inline_renderer.php';
