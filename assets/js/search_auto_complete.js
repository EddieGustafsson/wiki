...
let xhttp_search = new XMLHttpRequest();

xhttp_search.onreadystatechange = function () {
    if (this.readyState === 4 && this.status === 200) {

        json_search_data = JSON.parse(this.responseText);
        
        $("#query").typeahead({ source:json_search_data });

        }

};

xhttp_search.open("POST", "http://10.130.216.101/TP/api.php", true);
xhttp_search.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
xhttp_search.send("nyckel=x9qXnagSOsS6sHun&tjanst=wiki&typ=function&handling=skapa&funktion=sokFalt&wikiId=9&sok=");
